...
<div class="super_container">
	...
	<div class="btn-group">
			<button type="button" style="width:200px;" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown"  >My Profile</button>
			<div class="dropdown-menu " >
					<a href="{{URL::TO('myaccount')}}" class="dropdown-item">My Account</a>
            <a href="{{URL::TO('myOrders')}}" class="dropdown-item">My Orders</a>
					<a href="{{url('/supplier_login')}}" class="dropdown-item">Request To Add</a>
					<a href="{{url('/supplier_login')}}" class="dropdown-item">Requested Products</a>
	...
	<div class="sidebar" >
		...
		<div class="sidebar_logo">
			<a href="{{url('homepage')}}"><div>E-<span>Tribe</span></div></a>
		</div>

		<!-- Sidebar Navigation -->
		<nav class="sidebar_nav">
			<ul>
				<li><a href="{{url('/homepage')}}">home<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="{{url('/handcrafts')}}">Handcrafts<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="{{url('/arts')}}">Arts<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="{{url('/paintings')}}">Paintings<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="{{url('/forest_products')}}">Forest Products<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li>
					<a href="supplier_login"  >Request For Adding Product<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
			</ul>
		</nav>
						...
						<div class="col-xxl-3 col-md-6 footer_col">
							<div class="footer_about">
								...
								<div class="footer_logo" >
									<a href="{{asset('client/#')}}"><div>E-<span style="color:white;">Tribe</span></div></a>
								</div>
								<div class="cards">
									<ul class="d-flex flex-row align-items-center justify-content-start">
										<li><a href="{{asset('client/#')}}"><img src="{{asset('client/images/card_1.jpg')}}" alt=""></a></li>
										<li><a href="{{asset('client/#')}}"><img src="{{asset('client/images/card_2.jpg')}}" alt=""></a></li>
										<li><a href="{{asset('client/#')}}"><img src="{{asset('client/images/card_4.jpg')}}" alt=""></a></li>
										<li><a href="{{asset('client/#')}}"><img src="{{asset('client/images/card_3.jpg')}}" alt=""></a></li>
										<li><a href="{{asset('client/#')}}"><img src="{{asset('client/images/card_5.jpg')}}" alt=""></a></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="col-xxl-3 col-md-6 footer_col">
							<div class="footer_questions">
								...
								<div class="footer_list">
									<div>
									<ul>
										<li class="ulcolors"><a href="{{asset('client/#')}}">About us</a></li>

										<li class="ulcolors"><a href="{{asset('client/#')}}">Returns</a></li>
										<li class="ulcolors"><a href="{{asset('client/#')}}">Shipping</a></li>
										<li class="ulcolors"><a href="{{asset('client/#')}}">Partners</a></li>
										<li class="ulcolors"><a href="{{asset('client/#')}}">Support</a></li>
										<li class="ulcolors"><a href="{{asset('client/#')}}">Terms of Use</a></li>
									</ul>
									</div>
								</div>
							</div>
