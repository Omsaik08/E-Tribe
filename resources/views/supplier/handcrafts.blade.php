...
<div class="container mt-4">
	...
	<div class="home" style="background-image:url({{asset('client/images/elephant.png')}} ); width: 102.8%;height: 466px;left: -14px;top: -20px;" >
	</div>
								...
								<div class="product grid-item hot">
									<div class="product_inner">
										<div class="product_image">
											...
											<a href="{{asset('productcategoryimages/Handcrafts/'.$i->supplier_id.'/'.$i->image)}}">
